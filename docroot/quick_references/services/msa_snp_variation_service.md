...
## See also
* [MSA and SNP/Variation Analysis Service](https://dxkb.org/app/MSA)
...
The **Multiple Sequence Alignment** submenu option under the **"SERVICES"** main menu (Viral Services category) opens the MSA and SNP/Variation Service input form. *Note: You must be logged into dxkb to use this service.*
...
After selecting one of the output files by clicking it, a set of options becomes available in the vertical green Action Bar on the right side of the table. These include:
  ...
  - **MSA:** Displays the aligned FASTA directly on the dxkb site with the [MSA Viewer](/quick_references/other/msa_viewer).  
