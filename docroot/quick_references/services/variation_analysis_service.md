...
## See also
* [Variation Analysis Service](https://dxkb.org/app/Variation)
* [Variation Analysis Service Tutorial](/tutorial/variation_analysis/variation_analysis)

## Using the Variation Analysis Service
The **Variation** submenu option under the **Services** main menu (Genomics category) opens the Variation Service input form (*shown below*). *Note: You must be logged into dxkb to use this service.*
