...
## See also
* [Primer Design Service](https://dxkb.org/app/PrimerDesign)
* [Primer Design Service Tutorial](/tutorial/primer_design/primer_design)

## Using the Primer Design Service

The **Primer Design** submenu option under the **"SERVICES"** main menu (Viral Services category) opens the MSA and SNP/Variation Service input form. *Note: You must be logged into dxkb to use this service.*
