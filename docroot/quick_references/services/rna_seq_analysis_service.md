...
The RNA-Seq Service can be accessed from the Services Menu at the top of the dxkb website page and via the Command Line Interface (CLI).

## See also
* [RNA-Seq Analysis Service](https://dxkb.org/app/Rnaseq)
* [RNA-Seq Analysis Service Tutorial](/tutorial/rna_seq/rna_seq)

## Using the RNA-Seq Analysis Service
The **RNA-Seq Analysis** submenu option under the **Services** main menu (Transcriptomics category) opens the RNA-Seq Analysis input form (*shown below*). *Note: You must be logged into dxkb to use this service.*
...
* **gene_exp.gmx** - This file, generated by dxkb, describes the different contrast comparisons between conditions in terms of log ratios.
