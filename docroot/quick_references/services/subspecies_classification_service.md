...
## See Also
  * [Subspecies Classification Service](https://www.dxkb.org/app/SubspeciesClassification)
  ...
  * *Note: You must be logged into dxkb to use this service.*
...
## Query source
Users may enter their input sequence in this box, either by  directly pasting in a nucleotide sequence, or by selecting a FASTA file from the dxkb or uploading it to the site.
...
More details are available in the [Action Buttons](https://dxkb.org/docs/user_guides/action_buttons.html) user guide.
