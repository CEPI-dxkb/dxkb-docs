...
## See also
* [Core Genome MLST Analysis Service](https://dxkb.org/app/CoreGenomeMLST)
...
The **Core Genome MLST Analysis** option under the **Services** main menu under the **Phylogenomics** subheading, opens the Core Genome MLST Analysis Service input form (*shown below*). *Note: You must be logged into dxkb to use this service.*
...
This service accepts assembled genomes that are collected into one Genome Group. For more information about creating a genome group please visit our [documentation](https://www.dxkb.org/docs/quick_references/workspaces/groups.html) or our [video tutorial](https://www.youtube.com/watch?v=BDCUyhX9brA&t=36s)
