...
## See also
* [Model Reconstruction Service](https://dxkb.org/app/Reconstruct)
...
The **Model Reconstruction** submenu option under the **Services** main menu (Metabolomics category) opens the Reconstruct Metabolic Model input form (*shown below*). *Note: You must be logged into dxkb to use this service.* The Model Reconstruction service is also available via the dxkb Command Line Interface (CLI).
...
Clicking on the View icon at the upper right portion of the job result page will open a login screen for the ModelSEED. dxkb or RAST credentials can be used for login.
