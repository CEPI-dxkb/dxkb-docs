...
## See also
* [Protein Family Sorter Service](https://dxkb.org/app/ProteinFamily)
...
## Select Genome Group
Input box for selecting genome group(s) to include in the comparison.  Click the folder icon to navigate through the workspace to locate the genome group(s) of interest. Click the arrow icon (->) to add to the set of Selected Genomes. *Note: You must be logged into dxkb to access genome groups in your private workspace.*
