...
## See also
* [Docking Application](https://dxkb.org/app/Docking)
* [Docking Tutorial](/tutorial/docking/docking)

## Using the Docking Service
The **Docking** submenu option under the **"SERVICES"** main menu (Protein Tools category) opens the Docking Service input form. *Note: You must be logged into dxkb to use this service.*
...
the collection loaded into the dxkb resource. The **Preview PDB** button may be used
to preview the given PDB structure using the dxkb structure viewer.
