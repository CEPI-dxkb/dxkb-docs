...
## See also
* [Fastq Utilities Service](https://dxkb.org/app/FastqUtil)
* [Fastq Utilities Service Tutorial](/tutorial/fastq_utilities/fastq_utilities)

## Using the Fastq Utilities Service
The **Fastq Utilities** submenu option under the **Services** main menu (Genomics category) opens the Fastq Utilities input form (*shown below*). *Note: You must be logged into dxkb to use this service.*
...
**Note:** Extensive descriptions of the output files and options are provided in the [Fastq Utilities Service Tutorial](https://docs.alpha.dxkb.org/tutorial/fastq-utilities/fastq-utilities.html).
