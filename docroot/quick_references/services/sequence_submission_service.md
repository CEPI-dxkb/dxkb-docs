...
## See also
  * [Sequence Submission Service](https://dxkb.org/app/SequenceSubmission)
...
The **Seqeuence Submission** submenu option under the **"TOOLS & SERVICES"** main menu (Genomics category) opens the Sequence Submission Service input form. *Note: You must be logged into dxkb to use this service.*
...
Clicking the Submit Sequence button in the top right of the page to notify dxkb team for the submission is ready.
